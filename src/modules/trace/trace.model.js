...
const temperatureCheckDetailSchema = new mongoose.Schema({
  measuredCelsius:    { type: Number,  required: true },
  minAllowedCelsius:  { type: Number,  required: true },
  maxAllowedCelsius:  { type: Number,  required: true },
  isWithinRange:      { type: Boolean, required: true },
...
const weightCheckDetailSchema = new mongoose.Schema({
  measuredWeightGrams: { type: Number,  required: true },
  declaredWeightGrams: { type: Number,  required: true },
...
const stationSchema = new mongoose.Schema({
  ...
  notes:                           { type: String,  default: null },
  wasRefrigerated:                 { type: Boolean, required: true },
...
const productIngredientSchema = new mongoose.Schema({
  ingredientType: { type: String, required: true, enum: ["subProduct", "chemical"] },
...
const traceSchema = new mongoose.Schema(
  {
    ...
    requiresColdChain:{ type: Boolean, required: true, default: false },
